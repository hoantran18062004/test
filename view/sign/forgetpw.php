<section class="header_bottom">
        ...
        <section class="container ">
            ...
            <section class="sign_up">
                <form data-action="dangnhap" action="./index.php?act=quenmk" method="post" >
                        <h1>Quên mật khẩu</h1>
                        ...
                        <section class="form_signup">
                            <input type="email" name="email" value="<?php echo isset($_POST["email"]) ? $_POST["email"] : "" ?>"  placeholder="Vui lòng nhập email của tài khoản bạn" required>
                            <br>
