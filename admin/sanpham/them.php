<section class="admin-column_right">
    ...
    <span class="admin-column_right--linked"><b>Sản Phẩm</b> - Thêm sản phẩm</span>
    <br>
    ...
    if (isset($_POST["submit"])) {
        ...
        if($cheked){
            ...
            echo "<script language=javascript>alert('Them thanh cong')</script>";
        }
    ...
    <div class="form">
        <form style="margin-top: 0px;" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form_group">
                ...
                <input data-check= "true" type="text" value="<?php echo !empty($_POST["ten_sanPham"]) ? $_POST["ten_sanPham"] : null ?>" name="ten_sanPham">
            ...
            <div class="form_group">
                <label for="">Ảnh</label>
                <input data-check= "true" type="file" name="image" value="<?php echo !empty($_POST["image"]) ? $_POST["image"] : null ?>">
                <br>
                <img style="
                width: 50px;
                margin-top:10px;
    ...
    vertical-align: -webkit-baseline-middle;
            ...
            <div class="form_group">
                <label  for="">Giá</label>
                <input data-check= "true" type="text" name="price" value="<?php echo !empty($_POST["price"]) ? $_POST["price"] : null ?>">
            ...
            <div class="form_group">
                ...
                <input  type="text" name="luotxem" value="<?php echo !empty($_POST["luotxem"]) ? $_POST["luotxem"] : null ?>">
            ...
            <div class="form_group" style="display: flex;">
                ...
                <textarea  value="<?php echo !empty($_POST["moTa"]) ? $_POST["moTa"] : null ?>" style="outline: none;" name="moTa" id="" cols="30" rows="7">
                            <?php echo !empty($_POST["moTa"]) ? $_POST["moTa"] : "" ?>
            </textarea>
