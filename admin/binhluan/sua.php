<section class="admin-column_right">
    ...
    <span class="admin-column_right--linked"><b>Bình luận</b> - Sửa bình luận</span>
    <br>
    ...
    <!-- <div class="table table-category">
                ...
                <span>Thêm thành viên</span>
                        ...
                        <section class="form_signup">
                            <label for="">ID</label>
                            <input style="pointer-events: none;" type="text" value="<?php echo ($comment["id_bl"])? $comment["id_bl"] :"" ?>" name="id_bl" placeholder="ID">
                            <br>
